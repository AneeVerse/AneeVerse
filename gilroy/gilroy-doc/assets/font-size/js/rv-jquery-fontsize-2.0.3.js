...
;(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        bindControlerHandlers: function(){
            ...
            // decrease fn
            _self.$decreaseButton = $('.tx-decrease');
            ...
            // increase fn
            _self.$increaseButton = $('.tx-increase');
        ...
        defineElements: function() {
            ...
            if( _self.options.controllers.append !== false ){
                var resetButton = _self.options.controllers.showResetButton ? '<a href="#" class="tx-reset btn" title="Default font size">A</a>' : '';
                ...
                if( $.trim(template).length > 0 ){
                    ...
                    controllersHtml = '<div class="btn-group">' +
                                            '<a href="#" class="tx-decrease btn" title="Decrease font size">A-</a></li>' +
                                            resetButton +
                                            '<a href="#" class="tx-increase btn" title="Increase font size">A+</a></li>' +
                                      '</div>';
                }
        ...
        fontsizeChanged : function(){
            ...
            _self.$target.addClass( "tx-" +  currentFs);
